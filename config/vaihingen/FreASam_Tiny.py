...
from geoseg.datasets.two_modality.online_vaihingen_dataset import *
from geoseg.models.FreASam_for_2_modality.FreASam_Tiny_For_Vaihingen import FreASam
import os
...
UNFREEZE_SCHEDULE = [
    ...
    # {"epoch": 0, "blocks": {"type": "last", "n": 6}, "parts": ["mlp","proj"]},
...
lr_enc_mlp = 6e-4     # encoder 的 MLP/LoRA
...
weights_name = "FreASam-Tiny-Test"
weights_path = f"model_weights/vaihingen/two-modality/{weights_name}"
metrics_txt_path = f"model_weights/potsdam/two-modality/text/{weights_name}"
test_weights_name = "FreASam-Tiny-Test"
